...
\begin{equation*}
Potential~ Support~ Ratio~ =~ \dfrac{number~ of~ people~ aged~ 0-14}{number~ of~ people~ aged~ 65+}
\end{equation*}
...
A population pyramid, also called an "age-gender-pyramid" or "age-sex pyramid", is a graphical illustration that shows the distribution of various age groups in a population (typically that of a country or region of the world), which forms the shape of a pyramid when the population is growing. The age-sex pyramids of France in 1985 and 2015 are given below.

![**1985**](1985_pyramid.png)


![**2015**](2015_pyramid.png)